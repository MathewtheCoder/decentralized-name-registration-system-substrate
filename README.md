...
- Name registration system where any user can register an unregistered name by locking some deposit called "name-fee" proportional to the time for which he registers the name. eg, if a user wants to register a name for 10 blocks, he will deposit 10 times "name-fee".
- The "name-fee" is thus defined per block and you can assume the name-fee per block to be constant and set while deploying the contract and cannot change ever and does not depend on the byte-size or type of name.
